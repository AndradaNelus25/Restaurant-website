<?php
        ...
        // Retrieve the entered login information from the form
        $email = $_POST['emailLogin'];
        $password = $_POST['passwordLogin'];

        // Query the database to see if a record exists with the given email address
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          if(mysqli_num_rows($result) == 1){
            // Set session variable and redirect to dashboard page
...
<!-- <script>
        ...
        const emailSign = document.getElementById("emailValidationSign");
        const passwordSign = document.getElementById("passwordValidationSign");
        ...
        form.addEventListener("submit", function(event) {
          ...
          if (!emailInput.checkValidity()) {
            ...
            emailSign.innerHTML = "&#10060;"; // display X sign
            if (!confirm("Please enter a valid email address.")) {
              emailInput.focus(); // set focus back to the input
            }
            return;
          } else {
            emailSign.innerHTML = "&#10004;"; // display checkmark sign
          }
          ...
          if (!passwordInput.checkValidity()) {
            ...
            event.preventDefault();
            passwordSign.innerHTML = "&#10060;"; // display X sign
            return;
          } else {
            passwordSign.innerHTML = "&#10004;"; // display checkmark sign
          }
        });
    </script> -->
    ...
    <nav class="navbar">
       ...
       <div class="loginBigContainer">
        ...
        <h2>Login into your account or sign up if you don't already have one</h2>
          <form name="loginForm" method="post" action="login.php" id="loginForm">
            ...
            <span class="error" id="emailValidationSign"></span>
            <input type="password" id="passwordLogin" name="passwordLogin" placeholder="Password" required>
            <span class="error" id="passwordValidationSign"></span>
            
            <button type="submit" id="loginFormSend">Login</button>

            <p>Don't have an account yet? <a href="/signup.php" class="signUpButton">SignUp</a></p>
          </form>
        </div> 
       </div>
